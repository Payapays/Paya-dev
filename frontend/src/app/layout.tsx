...
export const metadata: Metadata = {
  metadataBase: new URL("https://payastakes.com"),
  title: {
    default: "PayaStakes | Decentralized Prediction Market on Stellar",
    template: "%s | PayaStakes",
  },
  description:
  ...
  alternates: {
    canonical: "https://payastakes.com",
  },
  authors: [{ name: "PayaStakes Team" }],
  creator: "PayaStakes",
  publisher: "PayaStakes",
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://payastakes.com",
    title: "PayaStakes | Decentralized Prediction Market",
